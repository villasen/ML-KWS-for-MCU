...
#define CONV5_DS_BIAS_LSHIFT 2
#define CONV5_DS_OUT_RSHIFT 6
#define CONV5_PW_BIAS_LSHIFT 2
#define CONV5_PW_OUT_RSHIFT 7

#define FINAL_FC_BIAS_LSHIFT 0
#define FINAL_FC_OUT_RSHIFT 8
